...
import { JoinRequest, JoinResponse, KeyValue, NewNodeRequest, NodeGoneRequest, RetrieveRequest, RetrieveResponse, StoreRequest, TransferRequest } from './proto/dht_pb';

export class DHTClient {
  private client: DHTServiceClient;

  constructor(ip: string, port: number) {
    this.client = new DHTServiceClient(`localhost:${port}`, grpc.credentials.createInsecure()); 
  }
